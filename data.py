...
<meta content="sub3/data.py · master · SSAFY 관리자 / ai-base" property="og:title">
...
<meta content="https://lab.ssafy.com/ssafyadmin/ai-base/blob/master/sub3/data.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="sub3/data.py · master · SSAFY 관리자 / ai-base" property="twitter:title">
...
<title>sub3/data.py · master · SSAFY 관리자 / ai-base · GitLab</title>
...
<meta name="csrf-token" content="dfvAG4EuEG2ROKQeQHt+JIMhaw+Jwc9wj21I2DSHMAeHGISMBc0y1/2kisg/H9Eje9qUegmBSN8V8hDfcnXdFQ==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/ssafyadmin/ai-base/blob/master/sub3/data.py">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="sub3/data.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/ssafyadmin/ai-base/blob/master/sub3/data.py"><strong>data.py</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/ssafyadmin/ai-base/blame/master/sub3/data.py">Blame</a><a class="btn" href="/ssafyadmin/ai-base/commits/master/sub3/data.py">History</a><a class="btn js-data-file-blob-permalink-url" href="/ssafyadmin/ai-base/blob/44ae8593e2c6636f50b62eecc2231ddb051689f2/sub3/data.py">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;sub3/data.py&quot;,&quot;gfm&quot;:&quot;`sub3/data.py`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-1bbf3f0e2e8f631ea6006c647f843db214684476054223102c16630dabc450d4.svg#duplicate"></use></svg></button>
<small>
9.21 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;ebf9a5ba3f3acbab55b5112085b47bdb0c4210a1&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-1bbf3f0e2e8f631ea6006c647f843db214684476054223102c16630dabc450d4.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/ssafyadmin/ai-base/raw/master/sub3/data.py"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="sub3/data.py" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/ssafyadmin/ai-base/raw/master/sub3/data.py?inline=false"><svg><use xlink:href="/assets/icons-1bbf3f0e2e8f631ea6006c647f843db214684476054223102c16630dabc450d4.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><button name="button" type="submit" class="btn js-edit-blob  js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/ssafyadmin/ai-base/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fssafyadmin%2Fai-base%2Fedit%2Fmaster%2Fsub3%2Fdata.py&amp;namespace_key=34">Edit</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/ssafyadmin/ai-base/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2F-%2Fide%2Fproject%2Fssafyadmin%2Fai-base%2Fedit%2Fmaster%2F-%2Fsub3%2Fdata.py&amp;namespace_key=34">Web IDE</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="replace" data-fork-path="/ssafyadmin/ai-base/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fssafyadmin%2Fai-base%2Fblob%2Fmaster%2Fsub3%2Fdata.py&amp;namespace_key=34">Replace</button><button name="button" type="submit" class="btn btn-remove js-edit-blob-link-fork-toggler" data-action="delete" data-fork-path="/ssafyadmin/ai-base/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fssafyadmin%2Fai-base%2Fblob%2Fmaster%2Fsub3%2Fdata.py&amp;namespace_key=34">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/ssafyadmin/ai-base/blob/master/sub3/data.py">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/ssafyadmin/ai-base/blob/master/sub3/data.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace data.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/ssafyadmin/ai-base/update/master/sub3/data.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="ABpmEpyWBNyv06rHyjCHrf6jpZGt7lPEKjTbGnwK91vy+SKFGHUmZsNPhBG1VCiqBlha5C2u1Guwq4MdOvgaSQ==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-39cc589d38d8b7013101d84f8a9274f2">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-39cc589d38d8b7013101d84f8a9274f2" class="form-control js-commit-message" placeholder="Replace data.py" required="required" rows="3">
Replace data.py</textarea>
</div>
</div>
</div>
